from app.core.abilities import filter_ability_effect_by_language, extract_abilities_of_pokemon
...
def test_filter_ability_by_language():
    expected = Ability(name='Overgrow',
...
def test_filter_ability_by_given_language_code():
    expected = Ability(name='Notdünger',
